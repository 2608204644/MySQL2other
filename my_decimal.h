#ifndef MYSQL2REDIS__MY_DECIMAL_H_
#define MYSQL2REDIS__MY_DECIMAL_H_
...
int decimal_get_binary_size(uint precision, uint scale);
...
#endif //MYSQL2REDIS__MY_DECIMAL_H_
